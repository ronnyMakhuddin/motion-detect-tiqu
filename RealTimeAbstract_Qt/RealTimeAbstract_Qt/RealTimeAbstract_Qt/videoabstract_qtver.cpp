...
//切换按钮
void VideoAbstract_QTver::on_pushButton_switch_clicked()
{
	emit sendSwitchToRealTimeForm();
}
	...
	: QWidget(parent, flags)
{
	...
	connect(drawForm, SIGNAL(sendLineAndRect(Point,Point,Point,Point,QString)), analyzeThread, SLOT(getShuaixuanData(Point,Point,Point,Point,QString)));
