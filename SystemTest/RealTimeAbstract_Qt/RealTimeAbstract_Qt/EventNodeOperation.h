...
public:
	...
	static void selectAbstractEvent(vector<EventNode>&eventList, Point lineP1, Point lineP2, Point rectP1, Point rectP2, int color, QString jihe, int waiguan, int leixing, int fps); //筛选摘要事件
